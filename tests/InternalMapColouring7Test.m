...
drawMapInt(map, d1n, 2, 'nodeMarker', 'none', 'lineWidth', 0.5,...
            ...
            'coloring', 'density', 'flatColoring', true, 'ColorMap', parula(7));
saveFigures('figures/flatDensity.png');
drawMapInt(map, d1n, 2, 'nodeMarker', 'none', 'lineWidth', 0.5,...
            'classes', col, 'markColour', colours, ...
            'coloring', 'density', 'flatColoring', false, 'ColorMap', parula(7));
saveFigures('figures/3DDensity.png');
...
saveFigures('figures/flatDensity2.png');
drawMapInt(map, d1n, 2, 'nodeMarker', 'none', 'lineWidth', 0.5,...
            'classes', col, 'markColour', colours, ...
            'coloring', col1, 'flatColoring', false, 'ColorMap', parula(7));
saveFigures('figures/3DDensity2.png');
...
drawMapInt(map, d1n, 2, 'nodeMarker', 'none', 'lineWidth', 0.5,...
            'classes', col, 'markColour', colours, ...
            'coloring', col1, 'flatColoring', true, 'ColorMap', parula(7));
saveFigures('figures/flatRisk.png');
drawMapInt(map, d1n, 2, 'nodeMarker', 'none', 'lineWidth', 0.5,...
            'classes', col, 'markColour', colours, ...
            'coloring', col1, 'flatColoring', false, 'ColorMap', parula(7));
saveFigures('figures/3DRisk.png');
